...
**Purpose.** Manage AI risk that is procured or embedded rather than built — due diligence, contract flow-downs, and ongoing monitoring.

**When to use it.** Before procuring AI; at each vendor review.
